...
Scene::Scene(Shader* shader)
{
	...
	skyline.model = std::make_shared<Model>(shader, triangles, "../Textures/skyline.png", skyline.transform.mat4());
	...
	buildings.model = std::make_shared<Model>(shader, triangles, "../Textures/buildings_bg.png", buildings.transform.mat4());
	...
	near_buildings.model = std::make_shared<Model>(shader, triangles, "../Textures/near_buildings_bg.png", near_buildings.transform.mat4());
	...
	pavement.model = std::make_shared<Model>(shader, triangles, "../Textures/pavement.png", pavement.transform.mat4());
	...
	truck.model = std::make_shared<Model>(shader, triangles, "../Textures/truck.png", truck.transform.mat4());
	...
	police_car.model = std::make_shared<Model>(shader,triangles, "../Textures/police_car.png", police_car.transform.mat4());
	...
	drone.model = std::make_shared<Model>(shader, triangles, "../Textures/drone_1.png", drone.transform.mat4());
	...
	character.model = std::make_shared<Model>(shader, triangles, "../Textures/character.png", character.transform.mat4());
